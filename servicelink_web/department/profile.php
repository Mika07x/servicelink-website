...
<head>
    ...
    <title>Profile Settings - ServiceLink Department</title>
                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="Department Administrator" readonly>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted mb-2">Department Administrator</p>

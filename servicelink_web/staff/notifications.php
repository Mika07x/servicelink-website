...
<head>
    ...
    <title>Notifications - ServiceLink Staff</title>
        ...
        <main class="dashboard-content">
            ...
            <?php if (empty($notifications)): ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">You don't have any notifications yet. We'll notify you when tickets are assigned to you or require your attention.</p>
                </div>
            <?php else: ?>
                <div class="row">
                    <div class="col-12">

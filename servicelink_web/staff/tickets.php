...
// Staff can see tickets from their department or assigned to them
...
<head>
    ...
    <title>Staff Tickets - ServiceLink</title>
...
<body>
                ...
                <div class="card-header bg-white border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">
                            <?php echo ($assigned_filter == 'me') ? 'My Assigned Tickets' : 'Department Tickets'; ?> (<?php echo $total_tickets; ?> total)
                        </h5>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (urlParams.has('status') || urlParams.has('priority') || urlParams.has('search') || urlParams.has('assigned')) {
                setTimeout(function() {

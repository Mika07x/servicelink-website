...
if (!$ticket_id) {
    header('Location: chat-support.php');
    exit;
}
...
// Get chat messages (all messages for admin)
$messages = [];
try {
    $stmt = $pdo->prepare("
...
<head>
    ...
    <title>Chat - Ticket #<?php echo htmlspecialchars($ticket['ticket_number']); ?> - ServiceLink Admin</title>
    ...
    <style>
        ...
        .message:not(.own):not(.internal) .message-content {
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group me-2">
                        <a href="chat-support.php" class="btn btn-outline-secondary">
                        ...
                        <div class="col-md-4 text-end">
                            <div class="d-flex align-items-center justify-content-end mb-2">
                                ...
                                <div class="text-start">
                                    ...
                                    <small class="text-muted"><?php echo htmlspecialchars($ticket['requester_name']); ?></small>
                                </div>
                            </div>
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button onclick="refreshChat()" class="btn btn-sm btn-outline-success me-2">
                            ...
                            <div class="chat-container" id="chatContainer">
                                ...
                                <?php else: ?>
                                    <?php foreach ($messages as $message): ?>
                                        ...
                                        ?>
                                        <div class="message <?php echo $is_own ? 'own' : ''; ?> <?php echo $is_internal ? 'internal' : ''; ?>">
                                            <div class="message-avatar" style="background-color: <?php echo $is_own ? '#28a745' : ($is_internal ? '#ffc107' : '#6c757d'); ?>">
                                                <?php echo strtoupper(substr($message['user_name'], 0, 2)); ?>
                                            </div>
                                            <div class="message-content">
                                                <?php if ($is_internal): ?>
                                                    <span class="badge bg-warning text-dark internal-badge">Internal</span>
                                                <?php endif; ?>
